...
from gridworld import environments
import policy as policy


def get_taxi_policy(env,
                    tabular_obs=True,
                    epsilon_explore=0.0):
    """
    """
def get_taxi_epsilon_greedy_policy(env, epsilon=0.1):
...
def get_gridwalk_policy(grid_env: environments.GridWalk,
                        tabular_obs=True,
                        epsilon_explore=0.0):
