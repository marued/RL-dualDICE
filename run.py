...
import algos.dual_dice as dual_dice
import algos.neural_dual_dice as neural_dual_dice
...
def get_env_and_policies(env_name, tabular_obs, alpha):
    ...
    if env_name == 'grid':
        ...
        policy1 = gridworld_policies.get_target_gridwalk_policy(
            env, tabular_obs)
    ...
    for seed in range(start_seed, start_seed + num_seeds):
        ...
        (target_data, target_avg_episode_rewards,
         target_avg_step_rewards) = transition_data.collect_data(
             ...
             max_trajectory_length,
             gamma=gamma)
        print('Target (oracle) average episode rewards',
              target_avg_episode_rewards)
        ...
        if tabular_obs:
            ...
            print('Empirical state density ratio',
                  empirical_density_ratio[:4], '...')
